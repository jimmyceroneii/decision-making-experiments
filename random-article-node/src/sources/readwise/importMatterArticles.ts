...
export const importMatterArticleToReadwise = async (params: ImportMatterArticleToReadwiseParams): Promise<void> => {
...
const main = async () => {
    await importMatterArticleToReadwise({ url: "https://www.platformer.news/meta-unspools-threads/" })
}
