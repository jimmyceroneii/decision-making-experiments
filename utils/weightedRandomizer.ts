...
const generateWeights = <T>({ list, weightFn }: GenerateWeightParams<T>): Weighted<T>[] => {
...
const weightedRandomizer = <T>({ list, weightFn }: WeightedRandomizerParams<T>): Weighted<T> | null => {
